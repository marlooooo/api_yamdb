# Generated by Django 3.0 on 2022-03-23 18:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', '0'), ('moderator', '1'), ('admin', '2')], default='user', max_length=10, verbose_name='role')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(default='Название категории', verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(default='Название жанра', verbose_name='Название')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviewses', to='reviews.Title')),
            ],
            options={
                'ordering': ('id',),
